  ...
  <div>
    <nav class="uk-navbar uk-navbar-container uk-margin mobile-nav">
      ...
      <div class="uk-navbar-right">
        ...
        >
          <select id="money-sym" class="" @change="onCurrencyChange()" v-model="currency">
          ...
          <button
            class="uk-button white-bg-button"
            id="drop-down"
            type="button"
            tabindex="-1"
    ...
    <nav class="uk-container desktop-nav" uk-navbar>
      <div class="uk-navbar-left">
          ...
          <li>
            <a>
              <div uk-form-custom="target: > * > span:first-child" class="">
                <select class="" @change="onCurrencyChange()" v-model="currency">
                  <option value="NGN">₦</option>
                  <option value="KES">Ksh</option>
                  <option value="USD">$</option>
                  <option value="GBP">£</option>
            ...
            <a>
              <div
                ...
                v-lazy:background-image="{
                  src: `https://drive.google.com/uc?export=view&id=${profiles.picture_id}`,
        ...
        <ul class="uk-list uk-list-divider">
          ...
          <div id="my-id" uk-modal>
            <div class="uk-modal-dialog uk-modal-body">
              ...
              <div class="uk-margin">
                <button class="uk-button red-button" @click="submitFeedback">
                  {{ feed }}
                </button>
              </div>
              <button class="uk-modal-close-default" type="button" uk-close></button>
      ...
      >
        ...
        <div id="main-cropper">
          ...
          <div class="uk-margin-top">
            <button @click="crop" class="uk-button">Done</button>
...
import {
  ...
  BoundingBox,
  DraggableArea,
} from "vue-advanced-cropper"; // using Static Cropper
...
export default {
  ...
  methods: {
    ...
    onCurrencyChange() {
      ...
      this.$emit("change-currency-symbol", this.currencySymbol);
