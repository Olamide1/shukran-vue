  ...
  methods: {
    login() {
      if (this.username == "" || this.password == "") {
        ...
        axios
          .post("https://shukran-api.herokuapp.com/api/login/", {
    ...
    switchSignupVisibility() {
      this.signupPasswordIcon =
        this.signupPasswordIcon === "icon: lock"
          ? "icon: unlock"
          : "icon: lock";
      this.signupPasswordFieldType =
        this.signupPasswordFieldType === "password" ? "text" : "password";
    },
    switchLoginVisibility() {
      this.loginPasswordIcon =
        this.loginPasswordIcon === "icon: lock" ? "icon: unlock" : "icon: lock";
        ...
        axios
          ...
          .then(res => {
            if (res.data.length >= 1) {
              ...
              axios
                .post("https://shukran-api.herokuapp.com/api/createaccount/", {
                  username: this.username.toLowerCase().trim(),
