            ...
            <li>
              <div class="uk-card-body" v-for="(profile, index) in profiles" :key="index">
                ...
                <div class="uk-margin" v-if="country_code == 'GB'">
                  <label for="sc" class="to-the-left"> Sort Code </label>
                  <input
                    name="sc"
                    type="text"
                    class="uk-input"
              ...
              <div class="uk-card-body">
                <div class="uk-margin">
                  <p class="digital-link-text">
                    ...
                    Fill in your link here. This link let's people access a certain
                    content only after they have tipped you. That means you don't have to
                    sell anything completely free anymore.
                  </p>
                  <p class="digital-link-text">
...
export default {
  ...
  data() {
    return {
      ...
      feed: "Submit",
      profile_picture: "",
      country_code: sessionStorage.getItem("shukran-country-data")
        ? JSON.parse(sessionStorage.getItem("shukran-country-data"))[
            "shukran-country-code"
          ]
        : "NG", // default is NG
      ngBanks: [,],
    };
    ...
    personalInfo() {
      ...
      axios
        ...
        .then(
          ...
          (err) => {
            console.error();
            "personalInfo error occured", error;
