  ...
  <div class="uk-container-expand">
    ...
    <nav class="desktop-nav" uk-navbar>
      ...
      <div class="uk-navbar-right">
        <ul class="uk-navbar-nav">
          <li>
            <a class="" href="#modal-middle" uk-toggle><button class="uk-button request-button uk-button-primary">
                Request payout
              </button></a>
          </li>
          <li>
          ...
          <li>
            <div class="uk-card-body" v-for="(profile, index) in profiles" :key="index" >
              ...
              <div class="uk-margin">
                ...
                <input name="un" type="text" class="uk-input" v-model="profile.username" placeholder="Username" />
              </div>
              <div class="uk-margin" v-if="country_code == 'NG'">
                <label for="pn" class="to-the-left"> Phone number </label>
                <input name="pn" type="text" class="uk-input" v-model="profile.phone" placeholder="Phone number" />
              </div>
